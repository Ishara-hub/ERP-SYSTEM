...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-4">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">Update item information</p>
            </div>
            <div class="flex space-x-3">
                <a href="{{ route('items.web.show', $item) }}" class="btn-secondary">
    ...
    <div class="bg-white rounded-lg shadow-sm border">
        <form action="{{ route('items.web.update', $item) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
                    ...
                    <div>
                        ...
                        <select name="parent_id" 
                            ...
                            @foreach($parentItems as $parent)
                                <option value="{{ $parent->id }}" {{ old('parent_id', $item->parent_id) == $parent->id ? 'selected' : '' }}>{{ $parent->item_name }}</option>
                            @endforeach
                        </select>
                        @error('parent_id')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div class="md:col-span-2">
                        <div class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   value="1"
                                   {{ old('enable_unit_of_measure', $item->enable_unit_of_measure) ? 'checked' : '' }}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="purchase_description" 
                                  ...
                                  placeholder="Description for purchase orders">{{ old('purchase_description', $item->purchase_description) }}</textarea>
                    ...
                    <div>
                        ...
                        <select name="cost_method" 
                            ...
                            <option value="FIFO" {{ old('cost_method', $item->cost_method) === 'FIFO' ? 'selected' : '' }}>FIFO</option>
                            <option value="LIFO" {{ old('cost_method', $item->cost_method) === 'LIFO' ? 'selected' : '' }}>LIFO</option>
                            <option value="Average" {{ old('cost_method', $item->cost_method) === 'Average' ? 'selected' : '' }}>Average</option>
                        </select>
                        @error('cost_method')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="cogs_account_id" 
                            ...
                            @foreach($cogsAccounts as $account)
                                <option value="{{ $account->id }}" {{ old('cogs_account_id', $item->cogs_account_id) == $account->id ? 'selected' : '' }}>{{ $account->account_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="preferred_vendor_id" 
                            ...
                            @foreach($suppliers as $supplier)
                                <option value="{{ $supplier->id }}" {{ old('preferred_vendor_id', $item->preferred_vendor_id) == $supplier->id ? 'selected' : '' }}>{{ $supplier->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="sales_description" 
                                  ...
                                  placeholder="Description for sales orders">{{ old('sales_description', $item->sales_description) }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               step="0.01"
                               min="0"
                               value="{{ old('sales_price', $item->sales_price) }}"
                    ...
                    <div>
                        ...
                        <select name="income_account_id" 
                            ...
                            @foreach($incomeAccounts as $account)
                                <option value="{{ $account->id }}" {{ old('income_account_id', $item->income_account_id) == $account->id ? 'selected' : '' }}>{{ $account->account_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="asset_account_id" 
                            ...
                            @foreach($assetAccounts as $account)
                                <option value="{{ $account->id }}" {{ old('asset_account_id', $item->asset_account_id) == $account->id ? 'selected' : '' }}>{{ $account->account_name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               step="0.01"
                               min="0"
                               value="{{ old('max_quantity', $item->max_quantity) }}"
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               step="0.01"
                               min="0"
                               value="{{ old('on_hand', $item->on_hand) }}"
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               step="0.01"
                               min="0"
                               value="{{ old('build_point_min', $item->build_point_min) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       {{ old('is_used_in_assemblies', $item->is_used_in_assemblies) ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       {{ old('is_performed_by_subcontractor', $item->is_performed_by_subcontractor) ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       {{ old('purchase_from_vendor', $item->purchase_from_vendor) ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" 
                                  ...
                                  placeholder="Additional notes about the item">{{ old('notes', $item->notes) }}</textarea>
                        @error('notes')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
