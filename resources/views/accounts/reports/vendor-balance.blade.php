...
<div class="min-h-screen bg-gray-50 py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Vendor Balance</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="mb-8 flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Vendor Balance Summary</h1>
        ...
        <div class="bg-white shadow-sm rounded-lg mb-6 no-print">
            <div class="p-6">
                <form method="GET" action="{{ route('accounts.reports.vendor-balance') }}" class="flex items-end space-x-4">
                    <div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <div class="px-6 py-8">
                <div class="text-center mb-8">
                    ...
                    <h3 class="text-lg font-semibold text-gray-700 uppercase tracking-tight">Vendor Balance Summary</h3>
                ...
                <div class="max-w-3xl mx-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr class="bg-gray-50">
                                <th class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Vendor Name</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($balanceData as $row)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $row['supplier_name'] }}</td>
                        ...
                        <tfoot>
                            <tr class="bg-gray-100 font-bold border-t-2 border-gray-300">
                                <td colspan="1" class="px-6 py-4 text-sm text-gray-900 uppercase tracking-wider">Total</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-right text-gray-900">
