    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <div class="nav-item">
                    <a href="{{ route('customer-payment.index') }}" class="nav-link {{ request()->routeIs('customer-payment.*') ? 'active' : '' }}">
                        <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="nav-item">
                    <a href="{{ route('record-deposit.index') }}" class="nav-link {{ request()->routeIs('record-deposit.*') ? 'active' : '' }}">
                        <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="nav-item">
                    <a href="{{ route('bank-reconciliation.index') }}" class="nav-link {{ request()->routeIs('bank-reconciliation.*') ? 'active' : '' }}">
                        ...
                        <span class="nav-text">Bank Reconciliation</span>
                    </a>
                </div>
            </div>
            ...
            <div class="nav-section">
                ...
                <div class="nav-item">
                    <a href="{{ route('journal-entries.web.index') }}" class="nav-link {{ request()->routeIs('journal-entries.*') ? 'active' : '' }}">
                        <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
