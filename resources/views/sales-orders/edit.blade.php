...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Update sales order details and items
                </p>
            </div>
        ...
        <!-- Form -->
        <form action="{{ route('sales-orders.update', $salesOrder) }}" method="POST" class="mt-6">
            @csrf
            @method('PUT')
                ...
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="date" name="delivery_date" id="delivery_date" value="{{ old('delivery_date', $salesOrder->delivery_date?->format('Y-m-d')) }}"
                                   class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                            @error('delivery_date')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select name="status" id="status" required
                                ...
                                <option value="delivered" {{ $salesOrder->status === 'delivered' ? 'selected' : '' }}>Delivered</option>
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <select name="payment_terms" id="payment_terms"
                                ...
                                <option value="Net 15" {{ $salesOrder->payment_terms === 'Net 15' ? 'selected' : '' }}>Net 15</option>
                                <option value="Net 30" {{ $salesOrder->payment_terms === 'Net 30' ? 'selected' : '' }}>Net 30</option>
                                <option value="Net 45" {{ $salesOrder->payment_terms === 'Net 45' ? 'selected' : '' }}>Net 45</option>
                                <option value="Net 60" {{ $salesOrder->payment_terms === 'Net 60' ? 'selected' : '' }}>Net 60</option>
                                <option value="Due on Receipt" {{ $salesOrder->payment_terms === 'Due on Receipt' ? 'selected' : '' }}>Due on Receipt</option>
                            </select>
                            @error('payment_terms')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="shipping_method" id="shipping_method" value="{{ old('shipping_method', $salesOrder->shipping_method) }}"
                                   class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <textarea name="shipping_address" id="shipping_address" rows="3"
                                      class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                      placeholder="Enter shipping address">{{ old('shipping_address', $salesOrder->shipping_address) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="billing_address" id="billing_address" rows="3"
                                      class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                      placeholder="Enter billing address">{{ old('billing_address', $salesOrder->billing_address) }}</textarea>
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <textarea name="notes" id="notes" rows="3"
                                      class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                      placeholder="Internal notes">{{ old('notes', $salesOrder->notes) }}</textarea>
                            @error('notes')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="terms_conditions" id="terms_conditions" rows="3"
                                      class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                      placeholder="Terms and conditions">{{ old('terms_conditions', $salesOrder->terms_conditions) }}</textarea>
                    ...
                    <div class="mt-8">
                        ...
                        <div id="line-items-container">
                            @foreach($salesOrder->lineItems as $index => $item)
                                <div class="line-item border border-gray-200 rounded-lg p-4 mb-4">
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-6">
                                        <div class="sm:col-span-2">
                                            <label class="block text-sm font-medium text-gray-700">Item</label>
                                            <select name="line_items[{{ $index }}][item_id]" required
                                                    class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="line_items[{{ $index }}][description]" value="{{ $item->description }}" required
                                                   class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700">Quantity</label>
                                            <input type="number" name="line_items[{{ $index }}][quantity]" value="{{ $item->quantity }}" step="0.01" min="0.01" required
                                                   class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700">Unit Price</label>
                                            <input type="number" name="line_items[{{ $index }}][unit_price]" value="{{ $item->unit_price }}" step="0.01" min="0" required
                                                   class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700">Tax Rate (%)</label>
                                            <input type="number" name="line_items[{{ $index }}][tax_rate]" value="{{ $item->tax_rate }}" step="0.01" min="0" max="100"
                                                   class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700">Discount Rate (%)</label>
                                            <input type="number" name="line_items[{{ $index }}][discount_rate]" value="{{ $item->discount_rate }}" step="0.01" min="0" max="100"
                                                   class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        </div>
                                    </div>
...
<script>
let lineItemIndex = {{ $salesOrder->lineItems->count() }};
