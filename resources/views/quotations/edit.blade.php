...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Form -->
        <form action="{{ route('quotations.update', $quotation) }}" method="POST" class="mt-6">
            @csrf
            @method('PUT')
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <select name="payment_terms" id="payment_terms"
                                ...
                                <option value="Net 15" {{ $quotation->payment_terms === 'Net 15' ? 'selected' : '' }}>Net 15</option>
                                <option value="Net 30" {{ $quotation->payment_terms === 'Net 30' ? 'selected' : '' }}>Net 30</option>
                                <option value="Net 45" {{ $quotation->payment_terms === 'Net 45' ? 'selected' : '' }}>Net 45</option>
                                <option value="Net 60" {{ $quotation->payment_terms === 'Net 60' ? 'selected' : '' }}>Net 60</option>
                                <option value="Due on Receipt" {{ $quotation->payment_terms === 'Due on Receipt' ? 'selected' : '' }}>Due on Receipt</option>
                            </select>
                            @error('payment_terms')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <textarea name="shipping_address" id="shipping_address" rows="3"
                                      class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                      placeholder="Enter shipping address">{{ old('shipping_address', $quotation->shipping_address) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="billing_address" id="billing_address" rows="3"
                                      class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                      placeholder="Enter billing address">{{ old('billing_address', $quotation->billing_address) }}</textarea>
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <textarea name="notes" id="notes" rows="3"
                                      class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                      placeholder="Internal notes">{{ old('notes', $quotation->notes) }}</textarea>
                            @error('notes')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="terms_conditions" id="terms_conditions" rows="3"
                                      class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                      placeholder="Terms and conditions">{{ old('terms_conditions', $quotation->terms_conditions) }}</textarea>
...
<script>
let lineItemIndex = {{ $quotation->lineItems->count() }};
