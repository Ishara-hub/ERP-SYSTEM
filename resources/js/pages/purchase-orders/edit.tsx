...
export default function PurchaseOrderEdit({ purchaseOrder, suppliers, items }: PurchaseOrderEditProps) {
    const [lineItems, setLineItems] = useState<LineItem[]>(
        purchaseOrder.items.map(item => ({
            id: item.id,
            item_id: item.item_id?.toString() || 'none',
    ...
    const { data, setData, put, processing, errors } = useForm({
        supplier_id: purchaseOrder.supplier.id.toString(),
        order_date: purchaseOrder.order_date,
        expected_delivery_date: purchaseOrder.expected_delivery_date || '',
        shipping_address: purchaseOrder.shipping_address || '',
        billing_address: purchaseOrder.billing_address || '',
        terms: purchaseOrder.terms || 'none',
        reference: purchaseOrder.reference || '',
        notes: purchaseOrder.notes || '',
        shipping_amount: purchaseOrder.shipping_amount.toString(),
        discount_amount: purchaseOrder.discount_amount.toString(),
