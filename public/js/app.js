...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var alerts = document.querySelectorAll('.alert[data-auto-hide]');
  ...
  var autoSubmitForms = document.querySelectorAll('[data-auto-submit]');
  ...
  // Date formatting
  var dateInputs = document.querySelectorAll('[data-date]');
...
window.ERP = {
  ...
  showToast: function showToast(message) {
    ...
    var toastContainer = document.getElementById('toast-container') || this.createToastContainer();
    var toast = this.createToast(message, type);
    toastContainer.appendChild(toast);
    var bsToast = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Toast(toast);
    bsToast.show();
  ...
  createToastContainer: function createToastContainer() {
  ...
  createToast: function createToast(message, type) {
    ...
    toast.innerHTML = "\n            <div class=\"toast-header ".concat(bgClass, " text-white\">\n                <strong class=\"me-auto\">").concat(type.charAt(0).toUpperCase() + type.slice(1), "</strong>\n                <button type=\"button\" class=\"btn-close btn-close-white\" data-bs-dismiss=\"toast\"></button>\n            </div>\n            <div class=\"toast-body\">\n                ").concat(message, "\n            </div>\n        ");
    return toast;
  },
  // Confirm action
  ...
  ajax: function ajax(url) {
    ...
    return fetch(url, _objectSpread(_objectSpread({}, defaultOptions), options)).then(function (response) {
      return response.json();
    })["catch"](function (error) {
      console.error('AJAX Error:', error);
      _this.showToast('An error occurred while processing your request', 'error');
    });
  }
};
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkerpsystem"] = self["webpackChunkerpsystem"] || [];
