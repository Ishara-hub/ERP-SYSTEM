...
<div class="container mt-4">
    <div class="card shadow">
        <div class="card-header bg-primary text-white">
            <h2 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Account</h2>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('chart-of-accounts.update', $account->id) }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="account_code" class="form-control" required value="{{ old('account_code', $account->account_code) }}">
                        @error('account_code')<div class="text-danger small">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Account Name</label>
                        <input type="text" name="account_name" class="form-control" required value="{{ old('account_name', $account->account_name) }}">
